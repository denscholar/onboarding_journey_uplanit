...
import 'package:uplanit_supplier/core/viewmodels/signup_model.dart';
...
class SignUpPagerTwo extends StatelessWidget {
  static const String ROUTE = '/signUpPagerTwo';
  ...
  Widget build(BuildContext context) {
    String displayName =
        context.select<SignUpModel, String>((value) => value.displayName);
          ...
          Container(
            ...
            child: InkWell(
              onTap: () async {
                ...
                //     MaterialPageRoute(builder: (context) => AccountSetupOne()));
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              InkWell(
                onTap: () => context.read<SignUpModel>().togglePassword(),
                child: Text(
                  context.watch<SignUpModel>().showPassword ? 'Show' : 'Hide',
                  style: GoogleFonts.workSans(
                    fontSize: 18.0,
                    fontWeight: FontWeight.w500,
                    color: Colors.white,
          ...
          CustomTextField(
            ...
            isPassword: context.watch<SignUpModel>().showPassword,
          ),
          SizedBox(height: 20),
        ],
      ),
